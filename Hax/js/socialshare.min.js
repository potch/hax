! function($) {
  ...
  Dropdown.prototype = {
    ...
    toggle: function(e) {
      ...
      $share_container = $(fb_iframe).css("width", providers.facebook["small-bubbles"]["data-width"]);
